        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ backgroundColor: '#F9FAFB', borderBottom: '1px solid #E5E7EB' }}>
              <th style={{ padding: '12px 16px', textAlign: 'left', color: '#6B7280', fontSize: '12px', fontWeight: 600 }}>Position</th>
              ...
              <th style={{ padding: '12px 16px', textAlign: 'left', color: '#6B7280', fontSize: '12px', fontWeight: 600 }}>Notifié</th>
            </tr>
          </thead>
          <tbody>
            {waitlist.map((item: any) => (
              <tr key={item.id} style={{ borderBottom: '1px solid #E5E7EB' }}>
                ...
                <td style={{ padding: '12px 16px', color: '#6B7280' }}>{item.profiles?.email || 'N/A'}</td>
