      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '40px 16px' }}>
        ...
        >
          ...
          <div style={{ marginTop: '60px', paddingTop: '40px', borderTop: '1px solid #E5E7EB' }}>
            <h2 style={{ fontSize: '28px', fontWeight: 700, color: '#1A1A1A', marginBottom: '24px' }}>
              Liste d\'attente
            </h2>
...
function WaitlistView({ eventId }: { eventId: string }) {
  ...
  if (loading) {
    return <p style={{ color: '#9CA3AF' }}>Chargement...</p>
  }
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ backgroundColor: '#F9FAFB', borderBottom: '1px solid #E5E7EB' }}>
              <th style={{ padding: '12px 16px', textAlign: 'left', color: '#9CA3AF', fontSize: '12px', fontWeight: 600 }}>Position</th>
              ...
              <th style={{ padding: '12px 16px', textAlign: 'left', color: '#9CA3AF', fontSize: '12px', fontWeight: 600 }}>Notifié</th>
            </tr>
          </thead>
          <tbody>
            {waitlist.map((item: any) => (
              <tr key={item.id} style={{ borderBottom: '1px solid #E5E7EB' }}>
                ...
                <td style={{ padding: '12px 16px', color: '#1A1A1A' }}>{item.profiles?.full_name || 'N/A'}</td>
                <td style={{ padding: '12px 16px', color: '#888888' }}>{item.profiles?.email || 'N/A'}</td>
