                  ...
                  >
                    ...
                    <div className="relative h-52 bg-gray-100 shrink-0 overflow-hidden">
                      ...
                      <div className="absolute top-3 left-3 right-3 flex justify-between items-start">
                        ...
                        {event.stand_count > 0 && (
                          <span className="text-[11px] font-bold px-2.5 py-1 rounded-full bg-black/50 text-white backdrop-blur-md flex items-center gap-1 ml-auto">
                            <Users size={10} /> {event.stand_count} stands
                          </span>
                        )}
                      </div>
