                    ...
                    <div className="relative shrink-0 overflow-hidden bg-gray-100">
                      {creator.portfolio_images?.length >= 2 ? (
                        ...
                        <div className="relative aspect-square">
                          <Image src={creator.portfolio_images[0]} alt={creator.full_name} placeholder="blur" blurDataURL="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAwIiBoZWlnaHQ9IjMwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjRjVGNUY3Ii8+PC9zdmc+" fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
                        </div>
                      ) : creator.avatar_url ? (
                        <div className="relative aspect-square">
                          <Image src={creator.avatar_url} alt={creator.full_name} placeholder="blur" blurDataURL="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAwIiBoZWlnaHQ9IjMwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjRjVGNUY3Ii8+PC9zdmc+" fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
                        </div>
                      ) : (
                      ...
                      {creator.portfolio_images?.length > 0 && creator.avatar_url && (
                        <div className="absolute bottom-3 left-3 w-9 h-9 rounded-full border-2 border-white overflow-hidden shadow-md">
                          <Image src={creator.avatar_url} alt="" placeholder="blur" blurDataURL="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAwIiBoZWlnaHQ9IjMwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjRjVGNUY3Ii8+PC9zdmc+" fill className="object-cover" />
                        </div>
                      )}
