  ...
  const sections = [
    {
      ...
      items: [
        ...
        { label: 'Numéro de TVA', value: 'FR29108170655' },
        { label: 'Code NAF', value: '70.21Z - Conseil en relations publiques et communication' },
        { label: 'Adresse du Siège', value: '47 Rue Vivienne, 75002 Paris' },
        { label: 'Domiciliation', value: 'Vivienne Domiciliation' },
        { label: 'Date de Création', value: '29 juillet 2026' },
      ],
    },
    {
      title: 'Dirigeants & Directeurs de Publication',
      icon: User,
      items: [
        { label: 'Président', value: 'Vincent Doucende' },
        { label: 'Directeur Général', value: 'Kalvin Paviel' },
  ...
  return (
    <div style={{ backgroundColor: 'var(--bg-primary)', minHeight: 'calc(100vh - 200px)' }}>
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '60px 16px' }}>
                    ...
                    <p style={{ fontSize: '16px', color: 'var(--text-primary)', fontWeight: 500, lineHeight: '1.6' }}>
                      {item.value.startsWith('http') ? (
                        <a
                          ...
                          onMouseEnter={(e) => (e.currentTarget.style.color = colors.purple.indigo)}
        ...
        >
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px', marginBottom: '32px' }}>
            <AlertCircle size={32} color={colors.violet.primary} strokeWidth={1.5} />
            <h2 style={{ fontSize: '28px', fontWeight: 700, color: 'var(--text-primary)' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px', marginBottom: '32px' }}>
            <Shield size={32} color={colors.violet.primary} strokeWidth={1.5} />
            <h2 style={{ fontSize: '28px', fontWeight: 700, color: 'var(--text-primary)' }}>
