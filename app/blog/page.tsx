...
const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    excerpt: 'Les organisateurs reçoivent des dizaines de candidatures. Des photos professionnelles peuvent faire toute la différence.',
    category: 'créateurs',
    readTime: 6,
    date: '2026-05-15',
  ...
  {
    id: '4',
    title: 'Les marchés artisanaux incontournables en France en 2026',
    excerpt: 'Du Marché de Noël de Strasbourg aux pop-ups parisiens, notre sélection des événements à ne pas manquer cette année.',
    category: 'créateurs',
    readTime: 5,
    date: '2026-05-10',
  ...
  },
  {
    ...
    excerpt: 'Une fiche événement bien rédigée, des disciplines ciblées, une communication soignée : voici comment rendre votre marché irrésistible.',
  ...
  },
  {
    ...
    excerpt: 'Répondre rapidement, donner un retour constructif, sélectionner avec équité… Un guide pour les organisateurs.',
    category: 'organisateurs',
    readTime: 6,
    date: '2026-05-28',
  ...
  },
  {
    ...
    excerpt: 'Lumières, signalétique, musique, restauration… Les marchés qui cartonnent pensent à chaque détail.',
    category: 'organisateurs',
    readTime: 7,
    date: '2026-05-18',
  ...
  },
  {
    ...
    excerpt: 'Pour renforcer la confiance sur la plateforme, Nexart introduit un système de badges "Créateur vérifié".',
    category: 'actualités',
    readTime: 3,
    date: '2026-06-06',
  ...
  },
  {
    ...
    excerpt: 'Céramique organique, bijoux minimalistes, textiles naturels… Notre analyse des tendances qui cartonnent.',
    category: 'actualités',
    readTime: 5,
    date: '2026-05-05',
    ...
    >
      <div style={{
        ...
        <span style={{
          ...
          borderRadius: '20px', backgroundColor: 'rgba(255,255,255,0.25)',
          color: '#FFF', backdropFilter: 'blur(4px)', textTransform: 'capitalize',
        }}>
          {article.category}
        </span>
      </div>
          ...
          <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
            {article.tags.slice(0, 2).map(tag => (
              <span key={tag} style={{
                ...
                borderRadius: '10px', backgroundColor: cat.bg, color: cat.color,
              }}>
                {tag}
              </span>
            ))}
...
export default function BlogPage() {
  ...
  const featCat = CATEGORY_COLORS[featured.category]

  return (
    <div style={{ backgroundColor: '#FFFFFF', minHeight: 'calc(100vh - 200px)' }}>
      <style>{`
        .blog-card:hover { box-shadow: 0 12px 32px rgba(0,0,0,0.10); transform: translateY(-4px); }
      `}</style>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '60px 16px 80px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: '18px', color: '#6B7280', marginBottom: '0', lineHeight: '1.6', maxWidth: '600px' }}>
        ...
        <div style={{
          ...
          marginBottom: '48px', display: 'flex', flexDirection: 'row', minHeight: '260px',
          cursor: 'pointer', boxShadow: '0 2px 12px rgba(0,0,0,0.06)',
        }}>
          <div style={{
            flex: '0 0 340px', background: featured.gradient,
          ...
          <div style={{ padding: '36px 40px', display: 'flex', flexDirection: 'column', justifyContent: 'center', flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
              <span style={{
                ...
                backgroundColor: featCat.bg, color: featCat.color, textTransform: 'capitalize',
              }}>
                {featured.category}
              </span>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <input
              ...
              style={{ padding: '12px 20px', borderRadius: '10px', border: 'none', fontSize: '14px', width: '280px', maxWidth: '100%', outline: 'none' }}
            />
            <button style={{
              padding: '12px 24px', borderRadius: '10px', border: 'none',
              backgroundColor: '#1A1A1A', color: '#FFF', fontSize: '14px', fontWeight: '700', cursor: 'pointer',
            }}>
              Je m&apos;inscris
            </button>
          </div>
