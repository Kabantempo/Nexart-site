            ...
            <FadeUp style={{ position: 'relative', zIndex: 10, flex: 1 }}>
              <div className="home-app-text">
                ...
                <div className="home-store-buttons">
                  <div title="Application iOS disponible bientôt" style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '14px 24px', borderRadius: '16px', border: '1px solid var(--home-bd2)', backgroundColor: 'var(--home-bg1)', textAlign: 'left', userSelect: 'none', cursor: 'not-allowed', opacity: 0.6 }}>
                  ...
                  <div title="Application Android disponible bientôt" style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '14px 24px', borderRadius: '16px', border: '1px solid var(--home-bd2)', backgroundColor: 'var(--home-bg1)', textAlign: 'left', userSelect: 'none', cursor: 'not-allowed', opacity: 0.6 }}>
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
