...
export default function HomeClient() {
  ...
  return (
    <div className="home-page overflow-x-hidden" style={{ marginTop: 'calc(-1 * var(--nav-height))', backgroundColor: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
      <Grain />
          ...
          <div className="relative flex flex-col lg:flex-row items-center gap-16">
            ...
            <FadeUp className="relative z-10 flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <div role="button" aria-disabled="true" title="Bientôt disponible sur App Store" className="flex items-center gap-3.5 px-6 py-3.5 rounded-2xl border border-white/12 bg-white/[0.04] text-left select-none cursor-not-allowed">
                ...
                <div role="button" aria-disabled="true" title="Bientôt disponible sur Google Play" className="flex items-center gap-3.5 px-6 py-3.5 rounded-2xl border border-white/12 bg-white/[0.04] text-left select-none cursor-not-allowed">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="white" opacity="0.5" xmlns="http://www.w3.org/2000/svg">
